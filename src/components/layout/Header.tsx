        ...
        <div className="hidden xl:flex items-center   justify-between w-full  ">
          ...
          <div>
            ...
            <nav className="flex flex-nowrap justify-center gap-4 sm:gap-5 lg:gap-6 text-center flex-shrink-0">
              <Link
                to="/"
                className="flex flex-col items-center text-xs sm:text-sm lg:text-base text-gray-600 hover:text-green-600 flex-shrink-0"
              >
          ...
          <nav className="flex justify-center gap-3 sm:gap-4 flex-wrap sm:flex-nowrap overflow-x-auto px-1 no-scrollbar">
            {[
              ...
              <Link
                key={idx}
                to={item.to}
                className="flex flex-col items-center text-xs sm:text-sm text-gray-600 hover:text-green-600 min-w-max flex-shrink-0"
              >
                {item.extra ? (
                  <div className="relative flex items-center justify-center w-9 h-9 sm:w-11 sm:h-11">
                    <div className="absolute top-0 left-1 w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center rounded-full border  bg-white">
